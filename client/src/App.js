      ...
      <div className='App'>
        <BrowserRouter>
          ...
          <Switch>
            ...
            <ProtectedRoute path='/charting' authorized={this.state.currentUser} redirect={'/signup'} render={props => <Charting {...props} cards={this.state.cards} columns={this.state.columns} />} />
